...
function MainIcons() {
    return (
        <div className="px-[40px] h-[120px] bg-white flex items-center justify-between text-[#6a6a6a] mb-4"> {/* ลด mb-4 */}
            {/* Carousel Section */}
            ...
            <div className="flex items-center gap-4">
                {/* Filters Button */}
                <div className="border border-gray-300 h-[60%] py-3 px-4 rounded-xl flex items-center gap-2 cursor-pointer">
                    <SlidersHorizontal />
