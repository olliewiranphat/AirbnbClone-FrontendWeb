                     ...
                     <tr key={booking.BookingID} className="hover:bg-gray-50">
                        ...
                        <td className="py-3 px-3">
                           <div className=" flex items-center justify-center">
                              ...
                              <ReloadLink to="/booking/payment" className="px-6 py-2 font-medium bg-[#fd2d52] text-white w-fit transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">
                                 Payment
                              </ReloadLink>
                           </div>
                        </td>
                        <td className="py-3 px-3">
                           <div className=" flex items-center justify-center">
                              ...
                              <ReloadLink to="booking/payment-cancel" className="px-6 py-2 font-medium bg-[#fd2d52] text-white w-fit transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">
                                 Cancel
                              </ReloadLink>
                           </div>
                        </td>
