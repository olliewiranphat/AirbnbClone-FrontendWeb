...
// export default function GuestDropdown({ onUpdateGuests }) {
//    const [isOpen, setIsOpen] = useState(true); // เริ่มต้นให้แสดงเมนูเลย
//    const [guests, setGuests] = useState({ adults: 1, children: 0, infants: 0, pets: 0 });
...
//    // เมื่อมีการเปลี่ยนแปลงค่า guests ให้ส่งข้อมูลกลับไปยัง parent component
//    useEffect(() => {
//       // ถ้ามี callback function onUpdateGuests จาก props
//       if (onUpdateGuests) {
//          // ส่งข้อมูล guests ปัจจุบันกลับไป
//          onUpdateGuests(guests);
//       }
//    }, [guests, onUpdateGuests]);

//    return (
//       <div className="relative w-64 border-none m-0 p-0 z-10 bg-white">
//          <p className="text-xs font-bold">GUESTS</p>
//          <button
//             className="w-full border-none rounded-sm p-0 flex justify-between items-center"
//             onClick={() => setIsOpen(!isOpen)}
...
//          {isOpen && (
//             <div className="w-full bg-white rounded-sm p-4 mt-2 z-10">
//                {[
//                   { label: "Adults", sub: "Age 13+", key: "adults" },
//                   { label: "Children", sub: "Ages 2–12", key: "children" },
//                   { label: "Infants", sub: "Under 2", key: "infants" },
