         ...
         <div className="p-1">
            ...
            <div className="grid grid-cols-2 gap-2 my-4 rounded-lg overflow-hidden">
               <div className="row-span-2 h-80 bg-gray-200 relative">
                  <img src={Pic1} alt="" className='object-cover h-full w-full' />
                  <button className="btn btn-outline absolute bottom-0 right-4 bg-white rounded-md px-2 text-xs">
                     <Grip className='w-4 h-2' />
                     Show all photos
                  </button>
               </div>
               <div className="grid grid-cols-2 gap-2 ">
                  <div className="h-[9.5rem] bg-gray-200 ">
                     <img src={Pic2} alt="" className='object-cover h-full w-full' />
                  </div>
                  <div className="h-[9.5rem] bg-gray-200">
                     <img src={Pic3} alt="" className='object-cover h-full w-full'  />
                  </div>
                  <div className="h-[9.5rem] bg-gray-200">
                     <img src={Pic4} alt="" className='object-cover h-full w-full'/>
                  </div>
                  <div className="h-[9.5rem] bg-gray-200 pt-2">
                     <img src={Pic5} alt="" className='object-cover h-full w-full ' />
                  </div>
               </div>
            </div>
